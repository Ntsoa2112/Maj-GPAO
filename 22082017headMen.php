	...
	//added by Vololona 13/08/2015
	  ...
	  FROM p_logon where id_pers=" . $_SESSION['id'];
				...
				if ($_SESSION['id_droit'] == 2 || $_SESSION['id_droit'] == 3 || $_SESSION['id_droit'] == 5 || $_SESSION['id_droit'] == 4 || $_SESSION['id_droit'] == 7) {
					...
					<li><a  class="hvr-bounce-to-right pull-left" href="http://doc.easytech.mg:8080/share/page/"  target="_blank" title="Gestion Documentaire Alfresco">G-DOC</a></li>
				...
				$menu .= '</ul>';
                                $menu .='<li> <a  class="hvr-bounce-to-right pull-right"  data-toggle="dropdown" class="dropdown-toggle" href="#">DEV <b class="caret"></b>|</a>'
                                        ...
                                        . '<li><a  class="hvr-bounce-to-right pull-left" href="http://10.128.1.246:1337/login" target="_blank">FICHE RECETTE</a></li>'
                                        . '<li><a  class="hvr-bounce-to-right pull-left" href="http://10.128.1.246:9090/login" target="_blank">TABLEAU DE BORD</a></li></ul></li>';
