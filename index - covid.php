...
//echo $c->enqueteDejaFait('ALL',"enquete_medaille");
    ...
    <div id="content">
        ...
        <div style="margin:40px; padding 100px"  >
            <br/>
            <center >
            <h1 style="background-color: red; text-transform: lowercase;">  
           <b> <span style="text-transform: uppercase;"> C</span>ovid19 -  Communication interne<span style="text-transform: uppercase;">  URGENTE</span></b>
           </center>
            </h1>
            <h2 style="background-color: red; text-transform: lowercase;">
            <span style="text-transform: uppercase;"> B</span>onjour à tous<br/>
            <span style="text-transform: uppercase;"> V</span>ous avez pu voir que la crise mondiale nous affecte directement bien que la pandémie <br/>
            "<span style="text-transform: uppercase;"> C</span>o<span style="text-transform: uppercase;"> V</span>id19"
 ne soit pas encore officiellement présente à <span style="text-transform: uppercase;"> M</span>adagascar.<br/>  
<b><span style="text-transform: uppercase;"> L</span>a cellule de crise à Madagascar a été mise en route</b>, en même temps que la cellule <br/>
de crise de notre groupe be Ys afin de gérer au mieux cette crise. <br/>
<b><span style="text-transform: uppercase;"> L</span>a priorité est limiter l'impact </b>sur la santé de l'ensemble de nos salariés, et de<br/>
 préserver au mieux notre capacité de production, pour être au rendez-vous lorsque l'activité <br/>
 reprendra. Dans ce cadre une série de mesures vont, ou sont déjà en place. <br/> 
 <span style="text-transform: uppercase;">U</span>ne grande partie de ces mesures ne seront efficaces <b>que si chacun est responsable et <br/>
 applique au minimum les recommandations</b>  que nous vous soumettons ci dessous,<br/> 
 complétées par toutes les informations officielles qui émaneront des autorités.</h2>
<h1 style="background-color: red; text-transform: lowercase;text-decoration: underline;"><span style="text-transform: uppercase; ">L</span>es mesures à prendre immédiatement, dans et hors des bureaux:</h1>
<h2 style="background-color: red; text-transform: lowercase;">
<ul>
<li>- se laver les mains le plus souvent possible et surtout après avoir été en contact avec<br/> des objets/personnes possiblement contaminés </li>
<li>- ne plus se serrer la main ou se faire la bise. C'est le moment de s'entrainer au  <br/>« NAMASTE » ou par le « FOOT SHAKE » très en vogue en ce moment...</li>
...
<li>- éviter de côtoyer des personnes ayant séjournées dans des zones infestées (Europe  <br/>
Asie Amérique Afrique du sud) , laissez passer la "quatorzaine" recommandée,</li>
<li>- si vous avez des symptômes, avez été en contact avec des cas, ou si vous avez un doute <br/>
 sur un collègue, surtout <b>informez votre supérieur!</b>   Nous devons prendre en charge la personne et l'accompagner au mieux. </li>
    </ul> </h2>
   
<h1 style="background-color: red; text-transform: lowercase; text-decoration: underline;">Les mesures préventives prises par la société (liste non exhaustive):</h1>
<h2 style="background-color: red; text-transform: lowercase;">
    <ul>
    <li>- plus de 2000 masques disponibles sur les 2 sites pour les personnes<br/>
     en contact des autres et les personnes qui auront les symptômes liés au CoVid19</li>
    <li>- plus de 500 flacons hydroalcooliques pour se désinfecter les mains dans les lieux de passage </li>
    <li>- contrôle de température de 100% des personnes rentrants dans les locaux et<br/>
     prise en charge si température suspecte: port du masque, accompagnement<br/>
      vers le centre Funhece, suivi de l'employé, etc...</li>
    ...
    <li>- nettoyages fréquents des "objets" touchés par plusieurs personnes</li> </ul>

    <h1 style="background-color: red; text-transform: lowercase;text-decoration: underline;">
Informations à savoir sur ce virus :</h1>
<h2 style="background-color: red; text-transform: lowercase;">
<ul>
...
<li>- Les symptômes sont la fièvre, toux, difficultés respiratoires. Les symptômes <br/>
 peuvent être légers (similaires à un rhume) ou plus sévères (tels que ceux associés <br/>à la pneumonie et à l’insuffisance pulmonaire ou rénale)</li>
<li>- les personnes en bonne santé ont un risque proche de 0 d'avoir de<br/> graves complications, et développent une immunité. </li> </ul>
<b>
Notez que les mesures préventives que l'on prend n'empêcheront pas le virus de circuler, mais il limitera la propagation,<br/>
 et par là évitera que trop de personnes soient malades en même temps, ce qui permettra à tout le dispositif médical en place <br/>
 de pouvoir gérer les cas les plus graves. </b>
<br/> <br/>
<i style="text-align: right;">La direction générale - Le comité de crise</i>
            ...
            <h2 style="background-color: red; text-transform: lowercase;">
            <center >
                <span style="text-transform: uppercase;">  D</span>ans le cadre de sa croissance, la soci&eacute;t&eacute; Easytech pr&eacute;voit <br/><br/> d&#39;ouvrir un second site de production sur la route de Digue.<br/><br/>
                <span style="text-transform: uppercase;"> C</span>e second site de production &agrave; pour but premier de permettre la croissance de l&#39;entreprise. <br/> <br/>
                <span style="text-transform: uppercase;"> I</span>l ne s&#39;agit en aucun cas d&#39;un d&eacute;m&eacute;nagement et nous ferons de notre mieux pour <br/><br/>que cette r&eacute;organisation n&#39;entraine pas une augmentation de la distance<br/> <br/> entre votre domicile et votre lieu de travail.
<br/><br/>
<span style="text-transform: uppercase;"> E</span>n cas de questions ou pour plus d&#39;&eacute;claircissement &agrave; ce sujet,<br/> <br/>nous vous invitons &agrave; vous adresser &agrave; votre sup&eacute;rieur direct.

               <br/>
                
                <span style="text-transform: uppercase;"> M</span>erci, <br/>
                <span style="text-transform: uppercase;"> L</span>a <span style="text-transform: uppercase;"> d</span>irection
                </center>
            </h2>
            -->
        </div>
