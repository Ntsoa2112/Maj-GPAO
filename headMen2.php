...
<div class="navbar navbar-inverse navbar-static-top menu_haut">
			...
			<ul class="nav navbar-nav"><li><a href="end.php"  class="logout" id="fermer_session" title="Fermer la session" 
					...
					?>><img src="img/deconnect.png" class="logout"/></a></li>
						...
						if ((isset($_SESSION['pseudo'])) && (!empty($_SESSION['pseudo']))) {
							echo '<li><a href="#" title="Cliquer pour vous deconnecter!" onClick="deconnect();">Bonjour ' . $_SESSION['pseudo'] . '</a></li>';
						}
						?>  
						</ul>
						</div>	
	...
	//added by Vololona 13/08/2015
	  ...
	  FROM p_logon where id_pers=" . $_SESSION['id'];
				...
				$menu .= '<li><a data-toggle="dropdown" class="dropdown-toggle" id="neocles" href="#">NEOCLES<b class="caret"></b></a>
						<ul class="dropdown-menu">
						<li><a href="neocles/index.php">PAGE </a></li><li> <a href="ldt.neocles.php">Ligne de temps</a></li></ul></li>';
				...
				$menu = '';
				$menu .= '<li><a href="#" data-toggle="modal" data-target="#login-modal"><BLINK>CONNEXION</BLINK></a></li>';
				$menu .= '</ul>';
