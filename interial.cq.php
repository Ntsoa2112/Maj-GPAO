...
<div id="mcorps">
    ...
    <div id="content">
        <center>
            ...
            $strNature = $c->getNatureTache();
            $strDistinction = $c->getDistinctionFacture();
            $strTraitement=$c->getTtraitement()
            ?>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>	
                                        <span>DISTINCTION</span><br/>
                                        <select  id="distinction">
                                            <?php
                                            echo $strDistinction;
                                            // echo "to be continued"
                                            ?>
...
// DAT 2012 03 06
        ...
        $.ajax({
            ...
            success: function(msg) {
                ...
                else
                {
                    ...
                    var pole = tk[2];
                    var strHTML = "";
                   strHTML += "<input type=\"hidden\" name=\"distinction\" id=\"idNature\" value=" + tk[9] + "> <table style=\"margin-top: 20px;margin-left: 7px;\" >";
                   strHTML += "<input type=\"hidden\" name=\"distinction\" id=\"idDistinction\" value=" + tk[10] + "> <table style=\"margin-top: 20px;margin-left: 7px;\" >";
                   strHTML += "<input type=\"hidden\" name=\"traitement\" id=\"idTraitement\" value=" + tk[11] + "> <table style=\"margin-top: 20px;margin-left: 7px;\" >";
                    ...
                    strHTML += "<tr><td valign=\"top\">ETAT : </td><td><select  class=\"sel\" id=\"idEtat\"><option value=\"\"></option><option value=\"a_controler\">a_controler</option><option value=\"en_cours\">en_cours</option><option value=\"en_instance\">en_instance</option></select></td></tr>";
    ...
    function updateCqLot()
    {
        ...
        var nature = $("#idNature").val();
        var distinction = $("#idDistinction").val();
        var traitement = $("#idTraitement").val();
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=updateCqLot&qt=" + qt + "&err=" + err + "&stat=" + stat + "&id=" + id + "&lib=" + lib + "&nature=" + nature +"&distinction="+distinction +"&traitement="+traitement+"&ldg=" + ldg + "&doss=" + doss + "&idpers=" + idpers + "&idNuo=" + idNuo + "&idEtat=" + idEtat + "&idPs=&isInterial=TRUE&is_rejet=false&idMotifRejet=0",
            success: function(msg) {
                alert(msg);
                goLdt("");
                $("#root").hide("slow");
    ...
    function goLdt(ordre)
    {
        ...
        var nature=($("#nature").val() == undefined) ? '' : $("#nature").val();
        var distinction=($("#distinction").val() == undefined) ? '' : $("#distinction").val();
        var traitement=($("#traitement").val() == undefined) ? '' : $("#traitement").val();
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=getLstLotAlmerys&doss=" + doss + "&ldg=" + ldg + "&mat=" + mat + "&stat=" + stat + "&etape=" + etape + "&prio=" + prio + "&last=" + last + "&name=" + name + "&ordre=" + ordre + "&isInterial=TRUE_"+nature+"_"+distinction+"_"+traitement+"&sat=&libretour=&typefav=",
            success: function(msg) {
