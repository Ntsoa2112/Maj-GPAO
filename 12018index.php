        ...
        <center>
            ...
            <div id="content" class="bodyWrap">
                ...
                <div class="row  main-slider" style="float: none;margin-left: auto;margin-right: auto;">
                    <div class="col-md-3 text-center wow fadeInLeft block" data-wow-duration="2000ms" data-wow-delay="300ms" >
                    ...
                    <div class="col-md-3 text-center wow scaleIn block" data-wow-duration="500ms" data-wow-delay="300ms">
                        <div class="mini">
                    ...
                    <div class="col-md-3 text-center wow fadeInRight block" data-wow-duration="2000ms" data-wow-delay="300ms">
                        <div class="mini">
                    ...
                    <!--MARIOLLLA CHANGE HERE WITH DIV-->

                    <div class="col-md-3 text-center wow scaleIn block" data-wow-duration="500ms" data-wow-delay="300ms">
                        <div class="mini">
                            <h3><a href="#">Les Documents sur BCR</a></h3>
                            <section id="slider">
                                <div class="containesr">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="block wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                                                <div id="owl-secondFiches" class="owl-carousel">
                                                    <div class="">
                                                        <a href="SMQ File/G_Fiche Réflexe_Protection des données V4 du 200117.pdf">G_Fiche Réflexe_Protection des données V4 du 200117</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Mode Opératoire de vérification avant MEP V4.pdf">Mode Opératoire de vérification avant MEP V4</a>
                                                    </div>
                                                    <div class="c">
                                                        <a href="SMQ File/Présentation Application du Privacy by Design.pdf">Présentation Application du Privacy by Design</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Présentation Sensibilisation G2S V3.pdf">Présentation Sensibilisation G2S V3</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Procédure d'Audit.pdf">Procédure d'Audit</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Procédure de Demande de modiifcation d'un traitement de DCP.pdf">Procédure de Demande de modiifcation d'un traitement de DCP</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Procédure de Gestion des mises à jour des BCR.pdf">Procédure de Gestion des mises à jour des BCR</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Procédure de Gestion des notifications des violations de données.pdf">Procédure de Gestion des notifications des violations de données</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Procédure de Gestion des plaintes et du droit à réparation pour violation des BCR.pdf">Procédure de Gestion des plaintes et du droit à réparation pour violation des BCR</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Procédure de Gestion du droit des personnes concernées.pdf">Procédure de Gestion du droit des personnes concernées</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Procédure de Gestion en cas de contrôle des Autorités de protecion des données.pdf">Procédure de Gestion en cas de contrôle des Autorités de protecion des données</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Référentiel d'enregistrement des mises à jour des BCR.pdf">Référentiel d'enregistrement des mises à jour des BCR</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Règles contraignantes d'entreprise BE INVEST.pdf">Règles contraignantes d'entreprise BE INVEST</a>
                                                    </div>
                                                    <div class="">
                                                        <a href="SMQ File/Règles contraignantes d'entreprise G2S.pdf">Règles contraignantes d'entreprise G2S</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- .col-md-12 close -->
                        ...
                        <a class="btn btn-primary " href="SMQ File/ListeFichiersPdf.php" ><i class="fa fa-hand-o-right fa-lg"></i> Documents sur BCR <i class="fa fa-angle-right"></i></a>
                    </div>


                    <?php
                    if ((isset($_SESSION['is_valide'])) && (!empty($_SESSION['is_valide'])))
                        if ($_SESSION['is_valide'] == true ) {
                            ?>
                            <div class="col-md-3 text-center wow scaleIn block" data-wow-duration="500ms" data-wow-delay="300ms">
                                <div class="mini">
                                    <h3><a href="#">Les Documents sur MCICARE</a></h3>

                                    <p class="text-justify"></p>
                                    <p class="text-justify">1-  Réseau de soin MCI Care TANA</p>
                                    <p class="text-justify">2-  Presantation MCI Care</p>

                                </div>
                                <a class="btn btn-primary " href="#" data-toggle="modal" data-title="MCI CARE" data-target="#modalMCICARE" ><i class="fa fa-hand-o-right fa-lg"></i> Documents sur MCICARE <i class="fa fa-angle-right"></i></a>
                            </div>
                            <?php
                        }
                    ?>
...
<!--modal MCICARE -->
<div class="modal fade" id="modalMCICARE" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">X</span><span class="sr-only">Close</span></button>
                    <h2 class="modal-title" id="titre_Nouvelle_Modal">Documentation</h2>
                </div>
                <div class="modal-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        <tr>
                            <td>Réseau de soin MCI Care TANA</td>
                            <td>reseau.pdf</td>
                            <td><a href="mcicare/reseau.pdf"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i>  Ouvrir</a></td>
                        </tr>
                        <tr>
                            <td>Presantation MCI Care</td>
                            <td>presentation.ppt</td>
                            <td><a href="mcicare/presentation.ppt"><i class="fa fa-file-powerpoint-o fa-2x" aria-hidden="true"></i>  Ouvrir</a></td>
                        </tr>
                        </tbody>
                    </table>
