...
// DAT 2012 03 06
	...
	*/
		...
		url: "php/link.php?action=getLdt&id="+id,
			success: function(msg){
				...
				else
				{
					...
					else $('option[value="2"]').attr('selected', 'true');
				}
			}
		});
	...
	function goLdt(ordre)
	{
		...
		$.ajax({
		type: "GET",
		url: "php/link.php?action=getLstLot&doss="+doss+"&ldg="+ldg+"&mat="+mat+"&stat="+stat+"&etape="+etape+"&prio="+prio+"&name="+name+"&ordre="+ordre,
			success: function(msg){
