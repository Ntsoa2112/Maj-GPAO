            ...
            <div id="content" class="bodyWrap">
				<div class="row main-slider" style="float: none;margin-left: 10%;margin-right: 10%;">
					<div class="block center">
						<h3 class="wtitle1"><i class="fa fa-envelope-o FAV_A" aria-hidden="true"></i> Bonjour,</h3>
						<h3 class="wtitle1">Suite au sondage effectué en fin d’année dernière, nous vous confirmons le regroupement de nos deux sites de production. 
						A partir du 5 Septembre prochain au plus tard, nos locaux de production seront situés à Tsiadana <a href="/map.php" >(voir carte ci-joint).</a>
						<br/>Nous vous invitons à vos rapprochez de vos CP pour toutes questions ou remarques liées à ce déménagement.
						</h3>
						
						<h4 class="wtitle1">Merci!</h4>
						<h4 class="wtitle1">La direction. </h4>
					</div>
...
<br/>
                   ...
                   <div  class=" text-center" >
					<img  class="center  wow scaleIn block" data-wow-duration="500ms" data-wow-delay="300ms" src="img/e1.JPG" /><br/>
<hr/>
<br/>

<img  class="center  wow scaleIn block" data-wow-duration="500ms" data-wow-delay="300ms" src="img/e2.JPG" />
