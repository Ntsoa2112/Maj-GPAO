...
<div class="navbar navbar-inverse navbar-fixed-top menu_haut" role="navigation">
	...
	//added by Vololona 13/08/2015
	  ...
	  FROM p_logon where id_pers=" . $_SESSION['id'];
				...
				$menu = '<li><a  class="hvr-bounce-to-right pull-right" href="index.php">ACCUEIL |</a></li><li><a  class="hvr-bounce-to-right pull-right" href="http://ticket.easytech.mg:8080/ ">TICKET |</a></li>';
