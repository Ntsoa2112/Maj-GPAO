                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>	
                                        ...
                                        <select  id="typefav"><option value=""></option>
...
//alert(tk[5]);		
                    ...
                    strHTML += '</td><td></td><td><select id="erreur11" class="ALMERYS_ERR_TYPE 11334 948"><option>Numero facture</option><option>Montant honoraire</option><option>B&#233;n&#233;ficiaire</option><option>Date des soins</option></select></td></tr>';


                    strHTML += '</td><td></td><td><select id="erreur12" class="ALMERYS_ERR_TYPE 11334 947"><option>Devis</option><option>erreur date de la PEC</option><option>Erreur de saisie acte TO</option><option>Inoch&#233;rence entre PEC et facture</option><option>Autres</option><option>Manque d&#233;tail : date d&#233;but Semestre acte TO</option><option>Demande assur&#233;e: la facture n\'aurait du pas &#234;tre saisie</option><option>IDT: il ne fallait pas saisir la facture</option><option>Facture assur&#233;e</option><option>Montant part RC non conforme</option><option>Aucune garanteie n\'a &#233;t&#233; trouv&#233;</option><option>Droit ferm&#233;</option><option>Autre+ case commentaire</option></select></td></tr>';


                    strHTML += '</td><td></td><td><select id="erreur13" class="ALMERYS_ERR_TYPE 11335 948"><option>Erreur date des soins </option><option>Erreur numero de facture</option></select></td></tr>';

                    strHTML += '</td><td></td><td><select id="erreur14" class="ALMERYS_ERR_TYPE 11335 947"><option>Erreur date des soins </option><option>Erreur numero de facture</option><option>manque d&#233;tail/part RC</option><option>manque d&#233;tail/ finess</option><option>facture illisible</option><option>incoh&#233;rence document tache</option><option>facture d&#233;j&#224; pay&#233;e</option><option>Absence de PEC</option><option>surcompl&#233;mentaire</option><option>non conformer PEC</option><option>facture partiellement illisible</option><option>facture + 2ans</option><option>Droit ferm&#233;</option><option>PEC en instance</option><option>Manque d&#233;tail</option><option>Consultation non autoris&#233;</option><option>PEC d&#233;j&#224; saisie</option><option>Demande assur&#233;e</option><option>Autre+ case commentaire</option></select></td></tr>';
//fin dentaire
