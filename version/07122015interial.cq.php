...
// DAT 2012 03 06
    ...
    function goLdt(ordre)
    {
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=getLstLotAlmerys&doss=" + doss + "&ldg=" + ldg + "&mat=" + mat + "&stat=" + stat + "&etape=" + etape + "&prio=" + prio + "&last=" + last + "&name=" + name + "&ordre=" + ordre + "&isInterial=TRUE_"+nature,
            success: function(msg) {
