...
//    fclose($img);
//    $query = "INSERT INTO p_depeche(nom_image, data_image, commentaire, titre_depeche) Values('$file_name',decode('{$es_data}' , 'hex'),'commentaire sur $file_name','titre image $file_name')";
...
//            pg_query('SET bytea_output = "escape";');
                        $query = "SELECT encode(data_image, 'base64') AS data, nom_image,commentaire,titre_depeche  FROM p_depeche";
//   $query = "SELECT lo_export(data_image, nom_image) AS data, nom_image,commentaire,titre_depeche  FROM p_depeche limit 1";
                        ...
                        foreach ($rs as $row) {
                            ?>
                            <div class="image_nouvel" class="data_modal_nouvel" href="#"  data-toggle="modal" data-title="Les Nouvelles" data-image="seza.jpg.jpg" data-target="#imageNouvelle" onclick="modal_nouvel(<?php echo $indexmodal; ?>)">     
                                <img  src="data:image/png;base64,<?php echo $row['data'] ?>" alt="" width="98%" height="200">

                                <h3 class="titre_Nouvel" style="margin-right:5%"><?php echo $row['titre_depeche']; ?></h3><p class="message_nouvel" style="margin-right:5%"><?php echo $row['commentaire'] ?></p>
                            </div>
                            <?php
                            $indexmodal++;
                        }
