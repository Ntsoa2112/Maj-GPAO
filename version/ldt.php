...
// DAT 2012 03 06
    ...
    //fonction pere;ttqnt de fqire une suppression de ligne de temps parmis les listes et insertion dans uen autre base
    ...
    function validateLdt(id)
    {
        
        $.ajax({
            type: "GET",
            url: "php/link.php?action=validateLdt&id=" + id,
            success: function (msg) {
                goLdt("");
            }
        });
        ...
        //fonction permettant d'annuler la fonction de validation dans la ligne de temps
    function revert(id)
    {
       $.ajax({
            type: "GET",
            url: "php/link.php?action=revert&id=" + id,
            success: function (msg) {
                goLdt("");
            }
        });  
    ...
    //creation de form pour la modification
    ...
    function updateLdt(id)
    {
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=updateLdt&deb=" + deb + "&fin=" + fin + "&qt=" + qt + "&err=" + err + "&stat=" + stat + "&id=" + id + "&ddeb=" + dDeb + "&dfin=" + dFin + "&com=" + com + "_" + dossier + "_" + etape + "_" + tempdoss,
            success: function (msg) {
                if (msg == "Ligne de temps en attente de validation")
                    alert(msg);
                else
                    alert("Mise en fil pour validation");
                goLdt("");
                $("#root").hide("slow");
            }
        });
