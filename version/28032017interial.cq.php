...
// DAT 2012 03 06
    ...
    function updateCqLot()
    {
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=updateCqLot&qt=" + qt + "&err=" + err + "&stat=" + stat + "&id=" + id + "&lib=" + lib + "&nature=" + nature +"&distinction="+distinction +"&ldg=" + ldg + "&doss=" + doss + "&idpers=" + idpers + "&idNuo=" + idNuo + "&idEtat=" + idEtat + "&idPs=&isInterial=TRUE&is_rejet=false&idMotifRejet=0",
            success: function(msg) {
                alert(msg);
                goLdt("");
                $("#root").hide("slow");
    ...
    function goLdt(ordre)
    {
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=getLstLotAlmerys&doss=" + doss + "&ldg=" + ldg + "&mat=" + mat + "&stat=" + stat + "&etape=" + etape + "&prio=" + prio + "&last=" + last + "&name=" + name + "&ordre=" + ordre + "&isInterial=TRUE_"+nature+"_"+distinction+"&sat=&libretour=&typefav=",
            success: function(msg) {
