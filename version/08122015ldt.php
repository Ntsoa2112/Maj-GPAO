...
// DAT 2012 03 06
    ...
    function updateLdt(id)
    {
        ...
        var dFin = $("#dFin").val();
        var com = $("#com").val();
        var dossier = $("#dossier").val(); //valeur choisi dans danssier
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=updateLdt&deb=" + deb + "&fin=" + fin + "&qt=" + qt + "&err=" + err + "&stat=" + stat + "&id=" + id + "&ddeb=" + dDeb + "&dfin=" + dFin + "&com=" + com + "_" + dossier + "_" + etape,
            success: function(msg) {
                //alert(msg);
                goLdt("");
                $("#root").hide("slow");
