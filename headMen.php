...
<div class="navbar navbar-inverse navbar-fixed-top menu_haut" role="navigation">
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right"><li class=""><!--<a href="end.php"  class="logout col-xs-1" id="fermer_session" title="Fermer la session" 
			...
			if ((isset($_SESSION['pseudo'])) && (!empty($_SESSION['pseudo']))) {
				$arrayAllowedMatricul = array('177' => '', '551'=>'','487'=>'');
                                //$arrayAllowedMatricul = array( '243' => '', '177' => '', '1' => '', '3' => '', '5' => '', '421' => '','60'=>'');
	...
	//added by Vololona 13/08/2015
	  ...
	  FROM p_logon where id_pers=" . $_SESSION['id'];
				...
				$menu = '<li><a  class="hvr-bounce-to-right pull-right" href="index.php">ACCUEIL |</a></li>'
                                        . '<li><a  class="hvr-bounce-to-right pull-right" href="sary.php?item=activite">ACTIVITE |</a></li>'
                                        . '<li><a  class="hvr-bounce-to-right pull-right" href="http://ticket.easytech.mg:8080/ ">TICKET |</a></li>';



				$menu .= '<li><a href="cons.php" class="hvr-bounce-to-right pull-right"  data-toggle="dropdown" class="dropdown-toggle"><blink>CONSIGNES</blink> <b class="caret"></b>|</a>'
                                        . '<ul class="dropdown-menu"><li><a class="hvr-bounce-to-right pull-left"  href="cons.php">CLASSIQUE</a></li>
                                        <li><a class="hvr-bounce-to-right pull-left"  href="consDetourage.php">DETOURAGE</a></li>'
                                        .'<li><a class="hvr-bounce-to-right pull-left"  href="consAlmerys.php">ALMERYS</a></li>'
                                        . '</ul>'
                                        . '</li>';
				$menu .= '<li><a  class="hvr-bounce-to-right pull-left" href="http://sondage.easytech.mg"  target="_blank" title="Evaluation">EVALUATION |</a></li>';
				...
				if ($_SESSION['id_droit'] == 2 || $_SESSION['id_droit'] == 3 || $_SESSION['id_droit'] == 5 || $_SESSION['id_droit'] == 4 || $_SESSION['id_droit'] == 7) {
					...
					<li><a  class="hvr-bounce-to-right pull-left" href="http://ged.easytech.mg/share"  target="_blank" title="Gestion Documentaire Alfresco">G-DOC</a></li>
				...
				$menu .= '<li><a  class="hvr-bounce-to-right pull-right"   data-toggle="dropdown" class="dropdown-toggle" id="neocles" href="#">NEOCLES<b class="caret"></b> |</a>
						<ul class="dropdown-menu">
						<li><a  class="hvr-bounce-to-right pull-left" href="neocles/index.php">PAGE </a></li><li> <a class="hvr-bounce-to-right pull-left" href="ldt.neocles.php">Ligne de temps</a></li><li> <a class="hvr-bounce-to-right pull-left" href="http://db1:1155/" target="_blank">Planning</a></li></ul></li>';
				...
				$menu .= '<li><a  class="hvr-bounce-to-right pull-right"  data-toggle="dropdown" class="dropdown-toggle" href="http://10.128.2.3/redmine" title="ALMERYS">ALMERYS<b class="caret"></b> |</a>
					<ul class="dropdown-menu"><li><a class="hvr-bounce-to-right pull-left"  href="consAlmerys.php">CONSIGNE Almerys </a></li>
                                        <li><a class="hvr-bounce-to-right pull-left"  href="interial.cq.php">INTERIAL </a></li>
                                        ';
				...
				$menu .= '</ul>';
                                $menu .='<li> <a  class="hvr-bounce-to-right pull-right"  data-toggle="dropdown" class="dropdown-toggle" href="#">DEV <b class="caret"></b>|</a>'
                                        . '<ul class="dropdown-menu"><li><a  class="hvr-bounce-to-right pull-left" href="http://redmine-dev.easytech.mg/" target="_blank">redmine-dev</a></li>'
                                        . '<li><a  class="hvr-bounce-to-right pull-left" href="http://10.128.1.246:1337" target="_blank">FICHE RECETTE</a></li>'
                                        . '<li><a  class="hvr-bounce-to-right pull-left" href="http://gpao-tdb.easytech.mg/login" target="_blank">TABLEAU DE BORD</a></li></ul></li>';
