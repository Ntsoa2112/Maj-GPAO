...
<div id="myCarousel" class="carousel slide" data-ride="carousel" >
	...
	<?php 
 $arr = $c->SelectDepartement(23);

	if(in_array($_SESSION['_ldName'],$arr) || ($_SESSION['id_droit']==5))
	{
		
		?>
   <video width="100%" controls>
     <source src='video/beys-neocles.mp4' type="video/mp4">
        video not supported
    </video>
	<?php
	}
...
//echo $c->enqueteDejaFait('ALL',"enquete_medaille");
    ...
    <div id="content">
        ...
        <div  >
        <header>
														<h2 class="major" style="font-size:2em;"><center><span>Covid19 -  Communication interne URGENTE</span></center></h2>
                                        </header>
                                        <div style="text-align:left; font-size:1em; margin: 40px;">
											

		<span style="text-align:left; font-size:1em;font-weight:bold;">Bonjour à tous</span><br><br>
		Vous avez pu voir que la crise mondiale nous affecte directement bien que la pandémie "CoVid19" ne soit pas encore officiellement présente à Madagascar.  <br> 
		<span style="font-weight:bold">La cellule de crise à Madagascar a été mise en route</span>, en même temps que la cellule de crise de notre groupe be Ys afin de gérer au mieux cette crise.  <br>
		<span style="font-weight:bold">La priorité est limiter l'impact</span> sur la santé de l'ensemble de nos salariés, et de préserver au mieux notre capacité de production, pour être au rendez lorsque l'activité reprendra. Dans ce cadre une série de mesures vont, ou sont déjà en place.   <br>
		Une grande partie de ces mesures ne seront efficaces <span style="font-weight:bold">que si chacun est responsable et applique au minimum les recommandations</span> que nous vous soumettons ci dessous, complétées par toutes les informations <span style="font-weight:bold">officielles</span> qui émaneront des autorités. <br><br>

		<span style="font-weight:bold; text-decoration:underline">Les mesures à prendre immédiatement, dans et hors des bureaux:</span>
		<ul style="text-align:left; font-size:1em;margin-left:10px;">
		<li>se laver les mains le plus souvent possible et surtout après avoir été en contact avec des objets/personnes possiblement contaminés</li>
		<li>ne plus se serrer la main ou se faire la bise.  C'est le moment de s'entrainer au « NAMASTE » ou par le « FOOT SHAKE » très en vogue en ce moment... </li>
		<li>!!! ne pas mettre sa main/doigts dans les muqueuses (bouche nez yeux) !!! </li>
		<li>éviter les rassemblements de plus de 5personnes,  </li>
		<li>Ceux qui peuvent venir à pied en vélo ou en motocyclette, préférez ce moyen aux bus </li>
		<li>éviter de côtoyer des personnes ayant séjournées dans des zones infestées (Europe Asie Amérique Afrique du sud) , laissez passer la "quatorzaine" recommandée,</li>
		<li>si vous avez des symptômes, avez été en contact avec des cas, ou si vous avez un doute sur un collègue,  <span style="font-weight:bold">surtout informez votre supérieur!</span>  Nous devons prendre en charge la personne et l'accompagner au mieux.  </li>
		</ul>
		<span style="font-weight:bold; text-decoration:underline">Les mesures préventives prises par la société (liste non exhaustive): </span>
		<ul style="text-align:left; font-size:1em;margin-left:10px;">

		<li>plus de   <span style="font-weight:bold">2000 masques disponibles</span> sur les 2 sites pour les personnes en contact des autres et les personnes qui auront les symptômes liés au CoVid19  </li>
		<li>plus de   <span style="font-weight:bold">500 flacons hydroalcooliques</span> pour se désinfecter les mains dans les lieux de passage </li>
		<li>contrôle de température de <span style="font-weight:bold">100% des personnes rentrants</span> dans les locaux et prise en charge si température suspecte: port du masque, accompagnement vers le centre Funhece, suivi de l'employé, etc... </li>
		<li>coordination avec la Funhece pour gérer les cas qui se présenteraient </li>
		<li>préparation des badges pour pouvoir pointer sans toucher  (Tsiadana) </li>
		<li>désinfection des locaux la nuit </li>
		<li>nettoyages fréquents des "objets" touchés par plusieurs personnes </li>
		</ul>
		<span style="font-weight:bold; text-decoration:underline">Informations à savoir sur ce virus : </span>
		<ul style="text-align:left; font-size:1em;margin-left:10px;">
		<li>transmission par salive / postillon en direct ou par vecteur (main, poignée de porte etc..)</li>
		<li>7 à 14j avant d'avoir des symptômes </li>
		<li>Les symptômes sont la fièvre, toux, difficultés respiratoires. Les symptômes peuvent être légers (similaires à un rhume) ou plus sévères (tels que ceux associés à la pneumonie et à l’insuffisance pulmonaire ou rénale) </li>
		<li>les personnes en bonne santé ont un risque proche de 0 d'avoir de graves complications, et développent une immunité. </li>
		</ul>
        <span style="font-weight:bold">Notez que les mesures préventives que l'on prend n'empêcheront pas le virus de circuler, mais il limitera la propagation, et par là évitera que trop de personnes soient malades en même temps, ce qui permettra à tout le dispositif médical en place de pouvoir gérer les cas les plus graves.</span>  <br>                                      
</div>
<div class="col-12">
...
<!-- Features -->
    <section class="box features">
        ...
        <header>
            <h2 class="major" style="font-size:2em;"><center><span>Covid 19 – FILAZANA MAIKA</span></center></h2>
        </header>
        <div style="text-align:left; font-size:1em; margin: 40px;"> 
        
        <span style="text-align:left; font-size:1em;font-weight:bold;">Miarahaba antsika rehetra</span><br><br>
Hiaraha-mahita ankehitriny fa misy fiantraikany mivantana aty amintsika ny fiparitahan’ny « Covid19 » na « Coronavirus », eny fa na dia tsy mbola voamarina amin’ny fomba ofisialy aza ny fisian’izany eto Madagasikara.<br>
Natsangana araka izany ny « cellule de crise » na komity mijery akaiky io krizy io eto amin’ny orinasa miaraka amin’ny « cellule de crise » any ivelany anivon’ny be|ys, izay vondron’orinasa misy antsika.<br>
Laharam-pahamehana ny famerana ny fiantraikan’io aretina io amin’ny fahasalaman’ny mpiasa ary koa ny fitsinjovana ny fahafahantsika mamokatra rehefa hiverina amin’ny laoniny ny asa rehetra. Efa misy ny fepetra noraisina sy mbola ho apetraka mifandraika amin’izany.<br>
Tsy hahomby anefa ireo fepetra ireo raha toa ka tsy mandray andraikitra ny tsirairay ary mampihatra ireto torolàlana voatanisa eto ambany ireto, miampy ireo izay mety ho henontsika amin’ny loharanom-baovao ofisialy.<br><br>
<span style="font-weight:bold; text-decoration:underline">Ireo fepetra mila ampiharina faran’izay haingana, na ato anatiny na ivelan’ny fiasana : </span>
<ul style="text-align:left; font-size:1em;margin-left:10px;">
<li>Manasa tànana matetika, indrindra rehefa avy nikasika zavatra na olona mety misy ny aretina</li>

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center wow fadeInLeft block" data-wow-duration="2000ms" data-wow-delay="300ms" >
                            ...
                            <div class="mini">
                                ...
                                <h3><a href="consignes/RI_Fr.pdf" target="blank" class="margin">Reglement interieur</a></h3>
                            ...
                            <a class="btn btn-primary border-box" href="consignes/RI_Mg.pdf" target="blank" class="margin"><i class="fa fa-hand-o-right fa-lg"></i> Reglement interieur <i class="fa fa-angle-right"></i></a>
                        ...
                        <div class="col-md-4 text-center wow fadeInRight block" data-wow-duration="2000ms" data-wow-delay="300ms">
                            <div class="mini">
                                <h3><a href="SMQ File/ListeFichiersPdf.php" target="blank" class="margin">BCR</a></h3>
                            ...
                            <a class="btn btn-primary " href="SMQ File/ListeFichiersPdf.php" target="blank"><i class="fa fa-hand-o-right fa-lg"></i> BCR <i class="fa fa-angle-right"></i></a>
                        </div>
                        <!--fin bcr--> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center wow fadeInRight block" data-wow-duration="2000ms" data-wow-delay="300ms">
                            ...
                            <a class="btn btn-primary " href="http://smq.easytech.mg/login?" target="blank"><i class="fa fa-hand-o-right fa-lg"></i> SMQ <i class="fa fa-angle-right"></i></a>
                                    ...
                                    <?php 
                                    if(isset($_SESSION['id_droit']) && !empty($_SESSION['id_droit'])) {
                                        $isOPValeur = ($_SESSION['id_droit'] == 1 ? true : false); 
                                        
                                        if(!$isOPValeur){
                                        echo '<div class="col-md-4 text-center wow fadeInRight block" data-wow-duration="2000ms" data-wow-delay="300ms">
                                        <div class="mini"><h3><a href="SMQ File/ListeFichiersPdfMCICare.php" target="blank" class="margin">MCI Care</a></h3>
                                        <div id="myCarousel2" class="carousel slide" data-ride="carousel">
                                        <ol class="carousel-indicators">
                                        <li data-target="#myCarousel2" data-slide-to="0" class="active"></li>
                                        <li data-target="#myCarousel2" data-slide-to="1"></li></ol>
                                        <div class="carousel-inner" role="listbox">   
                                                    <div class="item active">   
                                                    <br>
                                                    <br>
                                                    <br>
                                                    <a href="SMQ File/DocumentMCICare/présentation EASYTECH.ppt"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i>  Présentation EASYTECH</a>
                                                    </div>  
                                                    <div class="item">  
                                                    <br>
                                                    <br>
                                                    <br>
                                                        <a href="SMQ File/DocumentMCICare/Réseau de soin MCI Care TANA.pdf"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i>  Réseau de soin MCI Care TANA</a>
                                                    </div>
                                                </div>  
                                            </div>  
                                        </div>  
                                        <a class="btn btn-primary " href="SMQ File/ListeFichiersPdfMCICare.php" target="blank"><i class="fa fa-hand-o-right fa-lg"></i> MCI CARE <i class="fa fa-angle-right"></i></a>
                                    </div>' ;  
                                        }
                                    }else{
