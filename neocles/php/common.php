...
*/	
    ...
    function getListAbsence($date)
    {
	  ...
	  function GetDateMaha(){
			...
			$sql = "SELECT DISTINCT(CAST(date_arrivee AS date)) AS date_arr FROM helpdesk  ORDER BY CAST(date_arrivee AS date) DESC";				
	  ...
	  function RechercheMaha($_date , $_pole , $_client , $_intervenant , $_ticket){
			...
			$str = "<table id='table_1' class='value'><tr><td>Date d'arriv&eacutee</td><td>Heure</td><td>Client</td><td>Demandeur</td><td>Heure de creation du ticket</td><td>Numero de ticket</td><td>Pole actuel</td><td>Intervenant</td><td COLSPAN = 3>Commentaires</td><td>SLA</td><td>Modifier</td><td>Supprimer</td></tr>";
			...
			echo $typefin;
			*/
			function statistiqueMoisHelpdesk($date){
				$my = substr($date, 3);
				$debut = "01/".$my;
				$fin = "31/".$my;
				$m = substr($my,0,2);
				...
				$requete = "SELECT SUM(CAST(heure_creation_ticket AS TIME)) - SUM(CAST(heure_arrivee AS TIME)) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."'";				
				$str .= $this->getResFromReq($requete);
				$requete = "SELECT AVG(CAST(heure_creation_ticket AS TIME)) - AVG(CAST(heure_arrivee AS TIME)) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."'";				
				$str .= $this->getResFromReq($requete);
				$requete = "SELECT MAX((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."'";				
				$str .= $this->getResFromReq($requete);
				$requete = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."'";				
				$str .= $this->getResFromReq($requete);
				$requete = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) > ('00:30:00')";				
				$str .= $this->getResFromReq($requete);
				$requete = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) < ('00:15:00')";				
				$str .= $this->getResFromReq($requete);
				$requete = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) BETWEEN ('00:15:00') AND ('00:30:00')";				
				$str .= $this->getResFromReq($requete);
		...
		function RechercheMois($_date , $_pole , $_client , $_intervenant , $_ticket){
			$d = substr($_date,-2,2);
			$y = substr($_date,0, 4);
			$m = substr($_date,-5,2);
			$datem = $d."/".$m."/".$y;
			...
			if($_date != ""){
				//$requete = $requete." date_arrivee = '".$_date."'";
				//$requete = $requete." date_arrivee BETWEEN '".$debut."' AND '".$fin."'";
			...
			$str .= $this->statistiqueMoisHelpdesk($_date);

			$sql = $requete = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."'";
			$resultat = $this->cnx->query($sql);
			$dd = $resultat->fetch();
			$nbr_mails = $dd['resultat'];

			$sql = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) > ('00:30:00')";
			$resultat = $this->cnx->query($sql);
			$dd = $resultat->fetch();
			$mailsSup30 = $dd['resultat'];
			
			$sql = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) < ('00:15:00')";
			$resultat = $this->cnx->query($sql);
			$dd = $resultat->fetch();
			$dessous15 = $dd['resultat'];

			$sql = "SELECT COUNT(*) AS resultat FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) BETWEEN ('00:15:00') AND ('00:30:00')";
			$resultat = $this->cnx->query($sql);
			$dd = $resultat->fetch();
			...
			$sql = $requete = "SELECT date_arrivee, COUNT(*) as resulat_sup30 FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) > ('00:30:00') GROUP BY date_arrivee;";
			$resultat = $this->cnx->query($sql);
			$tab = $resultat->fetchAll();

			$sql = $requete = "SELECT date_arrivee, COUNT(*) AS resultat_inf15 FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) < ('00:15:00') GROUP BY date_arrivee;";
			$resultat = $this->cnx->query($sql);
			$nbr_Inf15 = $resultat->fetchAll();

			$sql = $requete = "SELECT date_arrivee, COUNT(*) AS resultat_15_30 FROM helpdesk WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."' AND ((CAST(heure_creation_ticket AS TIME)) - (CAST(heure_arrivee AS TIME))) BETWEEN ('00:15:00') AND ('00:30:00') GROUP BY date_arrivee;";
			$resultat = $this->cnx->query($sql);
...
$sql = $requete = "SELECT COUNT(*) AS resultat FROM supervision WHERE CAST(date_arrivee as date) BETWEEN '".$debut."' AND '".$fin."'";
		...
		function InsertHelpdesk($date_arrivee_php , $heure_arrivee_php , $client_php , $demandeur_php , $numero_ticket_php, $heure_creation_ticket_php, $pole_actuel_php, $intervenant_php, $commentaire_php,$tempsla_php){
			...
			$tempsla_sql = $this->cnx->quote($tempsla_php);


			
			$requete = "INSERT INTO helpdesk (date_arrivee,heure_arrivee,client,demandeur,heure_creation_ticket,numero_ticket,pole_actuel,intervenant,commentaire,sla) 
						VALUES ($date_arrivee_sql, $heure_arrivee_sql, $client_sql, $demandeur_sql,$numero_ticket_sql,
								$heure_creation_ticket_sql, $pole_actuel_sql, $intervenant_sql, $commentaire_sql,$tempsla_sql)";		
			...
			{	  // REUSSITE DANS DE L'inscription
				...
				$requete = "SELECT id FROM  helpdesk WHERE 
							...
							commentaire = $commentaire_sql AND
							sla = $tempsla_sql";
		...
		function UpdateHelpdesk($id , $date_arrivee_php , $heure_arrivee_php , $client_php , $demandeur_php , $heure_creation_ticket_php, $numero_ticket_php, $pole_actuel_php, $intervenant_php, $commentaire_php,$tempsla_php){
