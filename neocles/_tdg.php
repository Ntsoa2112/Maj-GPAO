					...
					<tr class="tb_header">
						...
						<div>
							...
							<td>
								...
								<span>Choix de dossier</span><br /><br />
							...
							<tr>
								<td  style="text-align:center" COLSPAN=3>
									<span> </span>
									<span>GetStats</span>
									<input type="submit" id="GetStats"  value="Lancer" title="GetStats" class=""/>								
								</td>
								<td COLSPAN=4>
...
// DAT 2012 03 06
	...
	$("#GetStats").click(function(){
		...
		$.ajax({
		type: "GET",
		url: "php/link.php?action=GetStats&idIntervenant="+idIntervenant+"&idTicket="+idTicket+"&jour="+jour+"&sujet="+sujet+"&statut="+statut+"&dateFin="+dateFin+"&dossier="+dossier+"&beneficiaire="+beneficiaire+"&demandeur="+demandeur+"&resolution_en_ligne="+resolution_en_ligne,
			success: function(msg){
				//alert(msg);
				$("#ldtCorp").html(msg);
			}
