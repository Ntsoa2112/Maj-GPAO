...
// DAT 2012 03 06
    ...
    $("#doss").change(function () {
       ...
       if(idDoss==712 || idDoss==577 || idDoss==579 || idDoss==578 || idDoss==580 || idDoss==29 || idDoss==582 || idDoss==663 || idDoss==721 || idDoss==723 || idDoss==724)
        {
            $("td #spehide").show();
            $("td #sousspehide").show();
        }
    ...
    /*    if (doss == "")
        ...
        $.ajax({
            type: "GET",
            url: "php/link.php?action=getLstLdt&doss=" + doss + "&mat=" + mat + "&deb=" + deb + "&fin=" + fin + "&stat=" + stat + "&orderby=" + orderBy + "&dep=" + dep + "&etape=" + etape + "&spe=" + specialite + "&sous_spe=" + sous_spe + "&sous_spe2=" + sous_spe2,
            success: function (msg) {
                $("#ldtCorp").html(msg);
            }
        });
