...
<div id="mcorps">
    <div id="head">
        ...
        //echo strtotime("2011/10/10 10:00:00");
        //exit();
        ?>
    </div>
    ...
    <table id="menu_droiteE">
        ...
        <?php if ((isset($_SESSION['id'])) && (!empty($_SESSION['id']))) if (!$c->enqueteDejaFait('')) { ?>
                <tr><td><a href="enquete.php" class="ri blink" style="background-color:#06c2e3" ><h3 class="blink">Enquete</h3></a></td></tr>
                <?php
            }
        if ((isset($_SESSION['pseudo'])) && (!empty($_SESSION['pseudo'])))
            echo $c->enqueteDejaFait('ALL');
        ?>
