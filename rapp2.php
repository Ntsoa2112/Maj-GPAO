  ...
  <div id="content"  style="margin: 30px;>
    ...
    <center>
      <div id="content_gauche">
        <a href="#showH" id="showH" class="suivi_heure">
          SUIVI HEURES/<blink>j</blink>
        </a>
...
function goPeriod() {
    ...
    $.ajax({
        type: "GET",
        url: "php/link.php?action=goPeriod&deb=" + deb + "&fin=" + fin,
...
function goDate() {
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            for (i = 0; i < 32; i++) {
                listeValeur[i] = 0;
                if (ArrayTemp[i] != undefined) listeValeur[i] = ArrayTemp[i];
                listeLabel[i] = i + 1;
            }
