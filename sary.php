<?php
	...
	$c = new Cnx();
	$divFluxImages  = $c->GetImageInDir($_REQUEST['item']);
	?>
<div id="mcorps">
	<div id="head">
		<?php
...
<body style="background:black;">
    ...
    <div id="slider1_container" style="position: relative; width: 800px;
        height: 800px; background-color:black;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 800px;
            overflow: hidden;">
			<?php
				echo $divFluxImages;
			?>
