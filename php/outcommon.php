...
//            return "aucun.htm";
   ...
   function getLdt($dossier, $etape, $lstPeriode, $matricule, $statut, $orderby,$lot_libelle, $dep, $deb, $fin, $spe, $sous_spe, $sous_spe2) {
       ...
       /* if ($sous_spe != "")
		...
		EXTRACT(EPOCH FROM (TO_TIMESTAMP(concat_ws(' ', p_ldt.date_fin_ldt, p_ldt.h_fin), 'YYYYMMDD HH24:MI:SS')-TO_TIMESTAMP(concat_ws(' ', p_ldt.date_deb_ldt, p_ldt.h_deb), 'YYYYMMDD HH24:MI:SS'))) as duree , p_lot_client.libelle as ldg,almerys_ss_spe.libelle  as sous_spe FROM p_ldt
			LEFT JOIN p_dossier ON p_ldt.id_dossier=p_dossier.id_dossier
