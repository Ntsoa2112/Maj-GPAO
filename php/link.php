...
switch ($action) {
    ...
    case "goDepartement":
        ...
        if ($fin != "")
            $filtre = $deb . ',' . $fin;
        $filtre = str_replace("/", "", $filtre);
        echo $c->SuiviDepartementPeriode($filtre);
    ...
    case "getListConnected":
        ...
        echo $c->getListConnected($doss, $dep,$matr);
        break;
    case "deleteReport":
        $id = $_REQUEST['id'];
    ...
    case "loadConsignes":
        ...
        break;
    case "loadConsignesAlmerys":
        $doss = $_REQUEST['doss'];
        $spec = $_REQUEST['spec'];
        $sspec = $_REQUEST['sspec'];
        $ssspec = $_REQUEST['ssspec'];
        echo $c->getLstConsigneAlmerys($doss, $spec,$sspec,$ssspec);
        break;
    ...
    case "goLotclient":
        ...
        if ($fin != "")
            $filtre = $deb . ',' . $fin;
        $filtre = str_replace("/", "", $filtre);
        echo $c->suiviDossierLotclient($filtre, $dossier);
        break;
    case "goClient":
        $deb = $_REQUEST['deb'];
        $fin = $_REQUEST['fin'];
        ...
        if ($fin != "")
            $filtre = $deb . ',' . $fin;
        $filtre = str_replace("/", "", $filtre);
        //echo $c->suiviDossierClient($filtre);
        echo $c->suiviDossierClient($filtre,$groupe);
        break;
    case "getLdt":
        $id = $_REQUEST['id'];
        echo $c->getOneLdt($id);
    ...
    case "getLstEtape":
     ...
     case "getLstEtapeAlmerys":
        $dossier = $_REQUEST['doss'];
        echo $c->getLstEtapeAlmerys($dossier);
        break;
    case "getLstTypeFav":
        $ldg = $_REQUEST['ldg'];
...
//        echo $c->InsertAlmerysUser($sat, $pole, $matr, $matCq, $isNovice);
    ...
    case "getLstPt":
        ...
        echo $c->lstPointage($date, $dateFin, $matricule, $typeT, $dep, $ch,$anomalie);
        break;
    case "getLstPtCpAlm":
        $date = $_REQUEST['dt'];
        $dateFin = $_REQUEST['dtfin'];
    ...
    case "getListGroupe":
        $idDossier = $_REQUEST['doss'];
        echo $c->getListGroupe($idDossier);
        break;
    case "updateTransfert":
        $lstId = $_REQUEST['lstId'];
        echo $c->updateTransfert($lstId);
        break;
     case "loadConsignesDet":
        $client = $_REQUEST['client'];
        echo $c->getLstConsigneDetourage($client);
        break;
        case "delConsigneDet":
        $id = $_REQUEST['id'];
        echo $c->delConsigneDet($id);
        break;
}
$c = null;
// AUT Mirah RATAHIRY
