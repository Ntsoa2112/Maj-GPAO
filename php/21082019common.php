...
//            return "aucun.htm";
   ...
   function getLdt($dossier, $etape, $lstPeriode, $matricule, $statut, $orderby,$lot_libelle, $dep, $deb, $fin, $spe, $sous_spe, $sous_spe2) {
	...
	p_lot_client.libelle as ldg,almerys_ss_spe.libelle  as sous_spe FROM p_ldt
			LEFT JOIN p_dossier ON p_ldt.id_dossier=p_dossier.id_dossier
                ...
                if($tempheurefin!="0:0:0")
                    {
                     ...
                     //ajouter d'autre contrainte pour plus de visibilité
    ...
    function suiviDossierPeriode($lstPeriode) {
        ...
        foreach ($rsDoss as $rowDoss) {
          ...
          //  return $sql;
           ...
           $str .= "<td>" . number_format( str_replace(',','', $this->ToHeureDecimal($somme)),2, ',', '') . "</td>";
            $str .= "<td>" . number_format( str_replace(',','', $this->ToHeureDecimal($pause)),2, ',', '') . "</td>";
            $str .= "<td>" .  number_format( str_replace(',','', $this->ToHeureDecimal($toillette)),2, ',', '') . "</td>";
            $str .= "<td>" .  number_format( str_replace(',','', $this->ToHeureDecimal($panne)),2, ',', '') . "</td>";
            $str .= "<td>" . number_format( str_replace(',','', $this->ToHeureDecimal($formation)),2, ',', '') . "</td>";
            $str .= "<td>" . number_format( str_replace(',','', $this->ToHeureDecimal($exo)),2, ',', ''). "</td>";
            $str .= "<td>" .  number_format( str_replace(',','', $this->ToHeureDecimal($autres)),2, ',', '') . "</td>";
...
//fonction permettant de lister les type existant pour chaque pole
    ...
    //fonction permettant d'afficher les suivi de dossier par étape sur une période dans le reporting
 ...
 $str .= "<tr>"
    ...
    //fonction permettant de valider les controle qualitï¿½ des saisie
...
/////////////////////////////////////////////////////////////fin ajout comptage cq////////////////////////////////////////
    ...
    ///fonction spï¿½cial pour le departemetn almerys pour filtre de sous spï¿½cialitï¿½
...
//            creation du fichier
        ...
        if ($matriPt != "") {
            ...
            //vÃ©rification si subordonee ou la personne
