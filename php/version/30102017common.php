...
";
 $sql .= $filtre_almerys;
        ...
        $ii = 0;
         ...
         $row = "Date debut\tDate fin\tAppelation\tMatricule\tDossier\tEtape\tLDG\tLot\tComment\tType\tHeure Debut\tHeure Fin\tDuree\tQuantite\tVitesse\tNombre Erreur\tStatut\n";
        ...
        {
  $row = "Date debut\tDate fin\tAppelation\tMatricule\tDossier\tSpecialite\tSous specialite\tSous sous specialite\tTache\tDistinct\tEtape\tLot\tComment\tType\tHeure Debut\tHeure Fin\tDuree\tQuantite\tVitesse\tNombre Erreur\tStatut\n";
        }
        if (!$isOP)
            fwrite($fw, $row);
...
//        return $fName;
    ...
    // $admin = array('487');
$admin = [1, 177, 551, 1020, 70, 6, 730, 552, 1084, 949, 421, 709, 725, 103,868,487];
