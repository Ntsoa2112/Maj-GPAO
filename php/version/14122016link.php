...
switch ($action) {
    ...
    case "updateCqLot":
        ...
        echo $c->UpdateCqLot($qt, $err, $stat, $id, $lib, $nature, $ldg, $doss, $id_pers, $idNuo, $idEtat, $idPs, $isInterial, $is_rejet, $idMotifRejet);
        break;
    case "saveMac":
        $id = $_REQUEST['id'];
    ...
    case "getLstLdt":
        ...
        if ($fin != "")
            $filtre = $deb . ',' . $fin;
        $filtre = str_replace("/", "", $filtre);
        echo $c->getLdt($dossier, $etape, $filtre, $mat, $stat, $orderby, $dep, $deb, $fin);
        break;
    // case "getLstLdtRecap":
    // $deb = $_REQUEST['deb'] ;
    // $fin = $_REQUEST['fin'] ;
    ...
    case "updateLdt":
        ...
        break;
    case "validateLdt": ///validation de Ldt
        $id = $_REQUEST['id'];
        echo $c->ValidateLdt($id, "TRUE");
        break;
    case "revert"://annuler la validation
        $id = $_REQUEST['id'];
        echo $c->ValidateLdt($id, "FALSE");
        break;
    case "getLstLot":
        $ldg = $_REQUEST['ldg'];
        $dossier = $_REQUEST['doss'];
