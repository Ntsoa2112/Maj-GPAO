...
//            return "aucun.htm";
   ...
   function getLdt($dossier, $etape, $lstPeriode, $matricule, $statut, $orderby, $dep, $deb, $fin, $spe, $sous_spe, $sous_spe2) {
 ...
 $sql .= $filtre_almerys;
  ...
  $test_app_export_value="";
   ...
   //    return $sql;
    ...
    function getLot($dossier, $lotClient, $matricule, $statut, $etape, $prio, $name, $ordre, $sous_spe) {
        $filtre = "";
        if ($dossier != "") {
