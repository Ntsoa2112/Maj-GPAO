...
WHERE 1=1 ";
 ...
 $sql .= $filtre_almerys;
  ...
  $isRed=false;
        ...
        <th class='th'  id='statu'>Statut</th>
        <th></th></tr></thead>";
  //        $row = "Date debut\tDate fin\tAppelation\tMatricule\tDossier\tSpecialite\tSous Specialite\tSous sous Specialite\tTache\tDistinct\tEtape\tLDG\tLot\tComment\tType\tHeure Debut\tHeure Fin\tDuree\tQuantite\tVitesse\tNombre Erreur\tStatut\n";
  $test_app_export_value="";
    ...
    $isRed=false;
                ...
                if ($row['heure_fin'] != "") {
                    ...
                    {
                    if( strtotime($row['heure_debut'])>strtotime($tempheurefin) && $matricule != "")
                        $isRed= true;
                    }
  ...
  ORDER BY almerys_p_lot.id_pers";
    ...
    function suiviDossierPeriode($lstPeriode) {
        ...
        foreach ($rsDoss as $rowDoss) {
            ...
            $str .= "<td>" .number_format( $this->ToHeureDecimal($somme),2, ',', '') . "</td>";
            $str .= "<td>" .number_format( $this->ToHeureDecimal($pause),2, ',', '') . "</td>";
            $str .= "<td>" .number_format( $this->ToHeureDecimal($panne),2, ',', '') . "</td>";
            $str .= "<td>" .number_format( $this->ToHeureDecimal($formation),2, ',', '') . "</td>";
            $str .= "<td>" .number_format( $this->ToHeureDecimal($exo),2, ',', '') . "</td>";
            $str .= "<td>" . number_format($this->ToHeureDecimal($autres),2, ',', '') . "</td>";
            $str .= "</tr>";
            $diff;
            $somme = "0:0:0";
            $pause = "0:0:0";
...
//fonction permettant de lister les type existant pour chaque pole
 ...
 $str .= "<tr>"
        ...
        foreach ($rsEtape as $rowDoss) {
         ...
         //   $str .= "<td>" . $somme . "</td>";
             $str .= "<td>" .number_format( $this->ToHeureDecimalAffiche($somme),2, ',', '') . "</td>";
            $str .= "<td>" . $sommeQte . "</td>";
            if($this->ToHeureDecimalAffiche($somme)!=0)
            {
             $str .= "<td>" . number_format( $sommeQte/$this->ToHeureDecimalAffiche($somme),2, ',', ''). "</td>";
            }
           else
              $str .= "<td></td>";   
            $str .= "</tr>";
