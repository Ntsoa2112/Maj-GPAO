...
//            return "aucun.htm";
   ...
   function getLdt($dossier, $etape, $lstPeriode, $matricule, $statut, $orderby,$lot_libelle, $dep, $deb, $fin, $spe, $sous_spe, $sous_spe2) {
	...
	CASE WHEN p_ldt.date_deb_ldt is not null or p_ldt.date_fin_ldt is not null THEN 0 ELSE EXTRACT(EPOCH FROM (TO_TIMESTAMP(concat_ws(' ', p_ldt.date_fin_ldt, p_ldt.h_fin), 'YYYYMMDD HH24:MI:SS')-TO_TIMESTAMP(concat_ws(' ', p_ldt.date_deb_ldt, p_ldt.h_deb), 'YYYYMMDD HH24:MI:SS'))) END as duree ,
