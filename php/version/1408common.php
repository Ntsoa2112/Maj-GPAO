...
//fonction peremttant de lister les categorie existant dans la table categorie
    function getLstCategorie() {
        $sql = "select id_categorie, libelle_categorie,effectif_echantillonage from p_lot_categorie order by id_categorie ";
        $rs = $this->cnx->query($sql);
...
//                    return "false be!!!";
            ...
            $limiteechantillonage = "SELECT almerys_category_daily.id_daily, almerys_category_daily.id_lotclient, almerys_category_daily.id_cq, almerys_category_daily.id_categorie,almerys_category_daily.date_deb,p_lot_categorie.effectif_echantillonage as limit
  FROM almerys_category_daily INNER JOIN p_lot_categorie on almerys_category_daily.id_categorie=p_lot_categorie.id_categorie where almerys_category_daily.id_lotclient=$ldg AND date_deb = '$datetoday' ";
