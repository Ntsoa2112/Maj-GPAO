...
//		GROUP BY p_ldt.id_pers,  r_personnel.appelation, id_type_ldt order by p_ldt.id_pers desc";
        // requete modifier pour le calcul de candence
		...
		where 1=1 		
		$filtreDepartement $filtreIntervaleTemps	$filtreDossier	$filtreMatricule
		GROUP BY p_ldt.id_pers,  r_personnel.appelation, id_type_ldt,p_ldt.h_fin,p_ldt.h_deb order by p_ldt.id_pers, id_type_ldt ";
       // return $sql;
        $ii = 0;
        $str = "<table class='hp'>";
