  ...
  $test_app_export_value="";
    ...
    $isRed=false;
                ...
                if ($row['heure_fin'] != "") {
                    ...
                    {
                    if( strtotime($row['heure_debut'])>strtotime($tempheurefin))
                        $isRed= true;
                    }
...
/////////////////////////////////////////////////////////////fin ajout comptage cq////////////////////////////////////////
    ...
    function loginOK($user, $pass) {
        ...
        $sql = "select ldap_name, nom, prenom , r_personnel.id_pers, id_droit, appelation, is_valide from r_personnel left join r_couverture_medical_pers on r_couverture_medical_pers.id_pers = r_personnel.id_pers where ldap_name = '$user'";
       $rs = $this->cnx->query($sql);
        ...
        while ($arr = $rs->fetch()) {
            ...
            $_SESSION['is_valide'] = $arr['is_valide'];
