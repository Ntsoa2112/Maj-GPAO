...
//		GROUP BY p_ldt.id_pers,  r_personnel.appelation, id_type_ldt order by p_ldt.id_pers desc";
        ...
        while ($arr = $rsDoss->fetch()) {
            ...
            $arrayDossier[$arr['dossier']] = $heureprod_dossier;
//    $heureprod_dossier+=
...
//        $tmpStr.="</table>";
        ...
        foreach ($arrayDossier as $key => $value) {
            $str.="<tr><td class='title3'>$key</td><td></td><td></td><td></td><td ><h4 class='title4 texte_bleu'>".number_format(($value / 3600), 2)."<h4></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
        }
