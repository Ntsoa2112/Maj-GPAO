...
switch ($action) {
    ...
    case "getLstLdt":
        ...
        if ($fin != "")
            $filtre = $deb . ',' . $fin;
        $filtre = str_replace("/", "", $filtre);
        echo $c->getLdt($dossier, $etape, $filtre, $mat, $stat, $orderby, $dep, $deb, $fin,$sous_spe,$sous_spe2);
        break;
    // case "getLstLdtRecap":
    // $deb = $_REQUEST['deb'] ;
    // $fin = $_REQUEST['fin'] ;
    ...
    case "getLstLot":
        ...
        echo $c->getLot($dossier, $ldg, $mat, $stat, $etape, $prio, $name, $orderby,$sous_spe);
        break;
...
//        echo $c->InsertAlmerysUser($sat, $pole, $matr, $matCq, $isNovice);
    ...
    case "getListSousSpecialite":
        ...
        echo $c->getLstSousSpecialite($idDossier);
        break;
