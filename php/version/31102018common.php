...
//VERSION AVANT DE REQUETE DUREE  DATE_PART('epoch', ('2011-12-29 '||p_ldt.h_fin)::timestamp - ('2011-12-29 '||p_ldt.h_deb)::timestamp ) as duree , 
        ...
        EXTRACT(EPOCH FROM (TO_TIMESTAMP(concat_ws(' ', p_ldt.date_fin_ldt, p_ldt.h_fin), 'YYYYMMDD HH24:MI:SS')-TO_TIMESTAMP(concat_ws(' ', p_ldt.date_deb_ldt, p_ldt.h_deb), 'YYYYMMDD HH24:MI:SS'))) as duree , 
  ...
  ORDER BY almerys_p_lot.id_pers";
    ...
    function suiviDossierPeriode($lstPeriode) {
        ...
        if (count($tk) > 1) {
            ...
            $filtrePeriode = "gb AND p_ldt.date_deb_ldt >=  '" . $tk[0] . "' AND p_ldt.date_deb_ldt <= '" . $tk[1] . "'";
        }
        $periode = $tk[0]." - ".$tk[1];
