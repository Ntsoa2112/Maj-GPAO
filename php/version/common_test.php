...
//            return "aucun.htm";
  ...
  if($dossier==712 || $dossier==577 || $dossier==579 || $dossier==578 || $dossier==580 || $dossier==29 || $dossier==582 || $dossier==663 ||  $dossier==721)
          {   
...
almerys_ss_spe2.libelle as sous_specialite2,
 ...
 $sql .= $filtre_almerys;
  ...
  //        $row = "Date debut\tDate fin\tAppelation\tMatricule\tDossier\tSpecialite\tSous Specialite\tSous sous Specialite\tTache\tDistinct\tEtape\tLDG\tLot\tComment\tType\tHeure Debut\tHeure Fin\tDuree\tQuantite\tVitesse\tNombre Erreur\tStatut\n";
    foreach ($rs as $row) 
         {
                ...
                $str .= "<td>" . $row['sous_specialite'] . "</td>";
                $str .= "<td>" . $row['sous_specialite2'] . "</td>";
                $str .= "<td>" . $row['tache'] . "</td>";
                ...
                $rw .= $row['dossier'] . "\t";
                $rw .= $row['specialite']. "\t";
                $rw .= $row['sous_specialite']. "\t";
                $rw .= $row['sous_specialite2'] . "\t";
                $rw .= $row['tache'] ."\t";
                $rw .= $row['distinction'] ."\t";
                $rw .= $row['etape'] ."\t";
              //  $rw .= $row['lib'] . "\t";
    ...
    function getLot($dossier, $lotClient, $matricule, $statut, $etape, $prio, $name, $ordre, $sous_spe) {
        $filtre = "";
        if ($dossier != "") {
            // spï¿½cifique pour le projet detourage ou il fallait rassembler tout les dossier
            if ($dossier == '39')
...
//        return $fName;
    ...
    function isSuperAdmin($matricule) {
     ...
     //$admin = array('487');
	//  $admin = [1, 177, 551, 1020, 70, 6, 730, 552, 1084, 949, 421, 709, 725, 103];
