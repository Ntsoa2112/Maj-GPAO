...
WHERE 1=1 ";
 ...
 $sql .= $filtre_almerys;
        ...
        $ii = 0;
         ...
         $row = "Date debut\tDate fin\tAppelation\tMatricule\tDossier\tEtape\tLDG\tLot\tComment\tType\tHeure Debut\tHeure Fin\tDuree\tQuantite\tVitesse\tPourcentage Erreur\tNombre Erreur\tStatut\n";
 ...
 $lastdatedebut="";
  ...
  $test_app_export_value="";
    ...
    $isRed=false;
		...
		<th class='th'  id='nbre_erreur'>NbErr</th>
		<th class='th'  id='statu'>Statut</th>
        <th class='th'  id='version_appli'>Version Appli</th>
        <th class='th'  id='quantite lot'>Quantite Lot</th>
		<th></th></tr></thead>";
...
//              $str .= '<tr  class = "th"><td><b>Total:</b></td><td></td><td></td></td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>' . number_format($hTotalLdt / 3600, 2) . '</b></td><td><b>' . $qteTotal . '</b></td><td><b>' . $totalVitess . '</b></td><td></td></tr>';
              $str .= '<tr  class = "th"><td><b>Total:</b></td><td></td><td></td></td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>' . number_format($hTotalLdt / 3600, 2, ',', '') . '</b></td><td><b>' . $qteTotal . '</b></td><td><b></b></td><td></td></tr>';
        }
        else
        {
//              $str .= '<tr  class = "th"><td><b>Total:</b></td><td></td><td></td></td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td><b>' . number_format($hTotalLdt / 3600, 2) . '</b></td><td><b>' . $qteTotal . '</b></td><td><b>' . $totalVitess . '</b></td><td></td></tr>';
    ...
    function getLot($dossier, $lotClient, $matricule, $statut, $etape, $prio,$checkonelot, $name, $ordre, $sous_spe) {
        ...
        ,p_lot.id_pers, p_lot.priority, p_lot.id_pers, p_lot.duree, p_lot.qte, p_lot.nbre_erreur,almerys_ss_spe.libelle as sous_spe FROM p_lot
